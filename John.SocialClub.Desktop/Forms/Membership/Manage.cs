...
namespace John.SocialClub.Desktop.Forms.Membership
{
    ...
    public partial class Manage : Form
    {
        ...
        private void Export_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Feature Diabled for now!");
            //try
            //{
        ...
        private void dataGridViewMembers_SelectionChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                if (dgv.SelectedRows.Count > 0)
                {
                    ...
                    //https://johnthiriet.com/back-to-basics-csharp-casting-an-integer-into-an-enumeration/

                    //cmb2Occupation.SelectedItem = (Occupation)dataRow["Occupation"];
                    cmb2Occupation.SelectedItem = (Occupation)Enum.Parse(typeof(Occupation), dataRow["Occupation"].ToString());
                    
                    //cmb2MaritalStatus.SelectedItem = (MaritalStatus)dataRow["MaritalStatus"];
                    cmb2MaritalStatus.SelectedItem = (MaritalStatus)Enum.Parse(typeof(MaritalStatus), dataRow["MaritalStatus"].ToString());

                    //cmb2HealthStatus.SelectedItem = (HealthStatus)dataRow["HealthStatus"];
                    cmb2HealthStatus.SelectedItem = (HealthStatus)Enum.Parse(typeof(HealthStatus), dataRow["HealthStatus"].ToString());
